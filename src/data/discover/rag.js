...
搭好了,怎么知道它好不好?上面说"章节切保结构、固定切保覆盖",那是我量出来的——但"量"本身也是一门学问。RAG 的每个环节(分块、嵌入、检索、生成)都能调,问题是:调完到底变好没有?靠肉眼感觉"看起来答得不错"不算数,它不可复现,还会骗你——答案更流畅了,事实可能反而更远了。这个系列一贯的态度:先量出来,再说好坏。
